...
class FlowMatcher(nn.Module):
    ...
    def get_loss_input(self, y_start_k):
        ...
        # noise sample
        if self.tied_lowfreq_indep_highfreq == True:
            ...
            noise = torch.randn_like(y_start_k[:, 0:1]).expand(-1, self.cfg.denoising_head_preds, -1, -1)                                         # [B, K, T, D]
        else:
    ...
    def sample(self, x_data, num_trajs, return_all_states=False):
        ...
        if tied_lowfreq_indep_highfreq == True:
